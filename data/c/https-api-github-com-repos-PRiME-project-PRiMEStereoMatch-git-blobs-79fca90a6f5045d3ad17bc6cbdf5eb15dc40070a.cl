...
__kernel void R(__global const float* a, __global float* b, unsigned int c, unsigned int d, int e, float f) {
...
__kernel void S(__global float* a, __global float* b, unsigned int c, unsigned int d, int e, float f) {
  size_t g = get_global_id(0);
  size_t h = get_global_id(2);
