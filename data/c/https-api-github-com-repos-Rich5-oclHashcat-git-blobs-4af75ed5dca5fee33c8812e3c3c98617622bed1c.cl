...
void BZ(u32 a[16], const u32 b, __global pw_t* c, __global kernel_rule_t* d, __global comb_t* e, __constant u32x* f, __global void* g, __global void* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global u32* o, __global u32* p, __global plain_t* q, __global digest_t* r, __global u32* s, __global salt_t* t, __global void* u, __global u32* v, __global u32* w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
        const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
  const u32 ah = get_local_id(0);

  const u32 ai = t[aa].salt_buf[0];

  u32 aj = a[0];

  for (u32 ak = 0; ak < ad; ak += 1) {
    const u32x al = f[ak / 1];
    ...
    {
      const u32 aq[4] = {aoo, app, app, app};
      if (Z(aq, i, j, k, l, m, n, o, p, x, y, z)) {
        int ar = X(aq, ae, &r[af]);
        if (ar != -1) {
          const u32 as = af + ar;
          if (atomic_add(&s[as], 1) == 0) {
            AA(q, v, aa, ar, as, ag, ak);
          }
        }
      }
    };
...
void CA(u32 a[16], const u32 b, __global pw_t* c, __global kernel_rule_t* d, __global comb_t* e, __constant u32x* f, __global void* g, __global void* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global u32* o, __global u32* p, __global plain_t* q, __global digest_t* r, __global u32* s, __global salt_t* t, __global void* u, __global u32* v, __global u32* w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
        const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
  const u32 ah = get_local_id(0);
  ...
  const u32 aj[4] = af[0], 0, 0, 0
};

u32 ak = a[0];

for (u32 al = 0; al < ad; al += 1) {
  const u32x am = f[al / 1];
  ...
  {
    if (((ap) == aj[0]) && ((aq) == aj[1]) && ((aq) == aj[2]) && ((aq) == aj[3])) {
      const u32 ar = af + 0;
      if (atomic_add(&s[ar], 1) == 0) {
        AA(q, v, aa, 0, ar, ag, al);
      }
    }
  };
}
...
__kernel void CB(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __constant u32x* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
                 const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
  ...
  const u32 ai = a[ag].pw_len;

  BZ(ah, ai, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ab, ac, ad);
}

__kernel void CC(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __constant u32x* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
                 const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
...
__kernel void CD(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __constant u32x* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
                 const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
...
__kernel void CE(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __constant u32x* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
                 const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
  ...
  CA(ah, ai, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ab, ac, ad);
}

__kernel void CF(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __constant u32x* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
                 const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
...
__kernel void CG(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __constant u32x* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
                 const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
