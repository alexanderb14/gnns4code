...
__kernel void J(__global uchar* a, uint b, uint c, uint d, uint e, uint f, __global uchar* g, uint h, uint i, uint j, uint k, uint l) {
  ...
  uchar4 p = vload4(0, m.ptr + 16);

  ushort8 q = convert_ushort8((uchar8)(o.s02468ACE));
  ushort8 r = convert_ushort8((uchar8)(o.s13579BDF));
    ushort8 s = convert_ushort8((uchar8)(o68, oE, p);
    ushort8 t = convert_ushort8((uchar8)(o79, oF, p);
    ushort8 u = convert_ushort8((uchar8)(o8A, o, p));
    ...
    vstore8(v, 0, (__global ushort *)n.ptr);
}
__kernel void K(__global uchar* a, uint b, uint c, uint d, uint e, uint f, __global uchar* g, uint h, uint i, uint j, uint k, uint l) {
  Image m = B(a, f, b, c, d, e);
  Image n = B(g, l, h, i, j, k);

  ushort8 o = vload8(0, (__global ushort*)G(&m, 0, 0));
  ushort8 p = vload8(0, (__global ushort*)G(&m, 0, 1));
  ushort8 q = vload8(0, (__global ushort*)G(&m, 0, 2));
  ushort8 r = vload8(0, (__global ushort*)G(&m, 0, 3));
  ushort8 s = vload8(0, (__global ushort*)G(&m, 0, 4));
  ...
  vstore8(convert_uchar8_sat(t), 0, n.ptr);
}