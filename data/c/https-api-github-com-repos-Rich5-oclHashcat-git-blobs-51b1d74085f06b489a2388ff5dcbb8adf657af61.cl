...
__kernel void EB(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global pdf_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  for (u32 an = 0; an < ab; an += 1) {
    ...
    { const u32 at[4] = { as0], as1], as2], as3] };
      if (Z(at, g, h, i, j, k, l, m, n, v, w, x)) {
        int au = X(at, ac, &p[ad]);
        if (au != -1) {
          const u32 av = ad + au;
          if (atomic_add(&q[av], 1) == 0) {
            AA(o, t, y, au, av, ah, an);
          }
        }
      }
    };
...
for (u32 ao = 0; ao < ab; ao += 1) {
  ...
  {
    if (((at[0]) == an[0]) && ((at[1]) == an[1]) && ((at[2]) == an[2]) && ((at[3]) == an[3])) {
      const u32 au = ad + 0;
      if (atomic_add(&q[au], 1) == 0) {
        AA(o, t, y, 0, au, ah, ao);
      }
    }
  };
