...
void DY(u64x a[8], const u64x b[8], __local u64 (*c)[256]) {
  u64x d[8];
  u64x e[8];
  u64x f[8];
...
__kernel void DZ(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  for (u32 ao = 0; ao < ab; ao += 1) {
    ...
    aw[0] = 0x0101010101010101;
    aw[1] = 0x0101010101010101;
    aw[2] = 0x0101010101010101;
    aw[3] = 0x0101010101010101;
    aw[4] = 0x0101010101010101;
    aw[5] = 0x0101010101010101;
    aw[6] = 0x0101010101010101;
    aw[7] = 0x0101010101010101;
    ...
    const u32x ay = D(aw[0]);
    const u32x az = E(aw[0]);
    const u32x ba = D(aw[1]);
    const u32x bb = E(aw[1]);

    {
      const u32 bc[4] = {ay, az, ba, bb};
...
for (u32 ap = 0; ap < ab; ap += 1) {
  ...
  ax[0] = 0x0101010101010101;
  ax[1] = 0x0101010101010101;
  ax[2] = 0x0101010101010101;
  ax[3] = 0x0101010101010101;
  ax[4] = 0x0101010101010101;
  ax[5] = 0x0101010101010101;
  ax[6] = 0x0101010101010101;
  ax[7] = 0x0101010101010101;
  ...
  const u32x az = D(ax[0]);
  const u32x ba = E(ax[0]);
  const u32x bb = D(ax[1]);
  const u32x bc = E(ax[1]);
