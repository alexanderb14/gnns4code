...
__kernel void C(__global pwsafe_pass* a, __constant pwsafe_salt* b) {
...
__kernel void E(__global pwsafe_pass* a, __global pwsafe_hash* b, __constant pwsafe_salt* c) {
  uint32_t d = get_global_id(0);
  __global uint32_t* e = (__global uint32_t*)a[d].v;
  uint32_t f = 0;
  __constant uint32_t* g = (__constant uint32_t*)c->hash;
