__kernel __attribute__((reqd_work_group_size(16, 4, 1))) void A(__global float* a, __global float* b, __constant float* c, int d, int e, int f) {
...
__kernel __attribute__((reqd_work_group_size(16, 8, 1))) void B(__global float* a, __global float* b, __constant float* c, int d, int e, int f) {
