...
int EB(__local RC4_KEY* a, u32 b[4], u32 c[8]) {
  DZ(a, b);
...
void ED(const u32 a[4], const u32 b[4], const u32 c[4], const u32 d[4], u32 e[4]) {
  u32 f = e[0];
  u32 g = e[1];
  u32 h = e[2];
  u32 i = e[3];
...
void EE(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4]) {
  a[0] = a[0] ^ 0x36363636;
  a[1] = a[1] ^ 0x36363636;
  a[2] = a[2] ^ 0x36363636;
  a[3] = a[3] ^ 0x36363636;
...
void EF(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4], u32 g[4]) {
  g[0] = e[0];
  g[1] = e[1];
  g[2] = e[2];
  g[3] = e[3];
...
void EG(const u32 a[4], const u32 b[4], const u32 c, const u32 d[4], u32 e[4]) {
  u32 f[4];
  u32 g[4];
  u32 h[4];
  u32 i[4];
...
__kernel void EH(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5pa_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  am[0] = s[y].timestamp[0];
  am[1] = s[y].timestamp[1];
  am[2] = s[y].timestamp[2];
  am[3] = s[y].timestamp[3];
  am[4] = s[y].timestamp[4];
  am[5] = s[y].timestamp[5];
  am[6] = s[y].timestamp[6];
  am[7] = s[y].timestamp[7];
