...
u8 BZ(__local RC4_KEY* a, u8 b, u8 c, __global u32* d, u32 e[4]) {
  for (u32 f = 0; f < 4; f++) {
    u32 g = 0;
...
void CC(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4]) {
  a[0] = a[0] ^ 0x36363636;
  a[1] = a[1] ^ 0x36363636;
  a[2] = a[2] ^ 0x36363636;
  a[3] = a[3] ^ 0x36363636;
...
void CD(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4], u32 g[4]) {
  g[0] = e[0];
  g[1] = e[1];
  g[2] = e[2];
  g[3] = e[3];
...
int CE(__local RC4_KEY* a, u32 b[4], __global u32* c, const u32 d, const u32 e[4], const u32 f[4]) {
  BY(a, b);
...
void CF(const u32 a[4], const u32 b[4], const u32 c, const u32 d[4], u32 e[4], u32 f[4]) {
  u32 g[4];
  u32 h[4];
  u32 i[4];
  u32 j[4];
...
void CG(__local RC4_KEY* a, u32 b[4], u32 c[4], u32 d[4], u32 e[4], const u32 f, __global pw_t* g, __global kernel_rule_t* h, __global comb_t* i, __global bf_t* j, __global void* k, __global void* l, __global u32* m, __global u32* n, __global u32* o, __global u32* p, __global u32* q, __global u32* r, __global u32* s, __global u32* t, __global plain_t* u, __global digest_t* v, __global u32* w, __global salt_t* x, __global krb5tgs_t* y, __global u32* z, __global u32* aa, const u32 ab,
  ...
  for (u32 ao = 0; ao < ah; ao++) {
    ...
    if (CE(&a[al], as, y[ae].edata2, y[ae].edata2_len, ar, am) == 1) {
