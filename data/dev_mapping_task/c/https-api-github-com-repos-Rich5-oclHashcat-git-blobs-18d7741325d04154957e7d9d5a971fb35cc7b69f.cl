...
void BX(u32x a[2], u32x b[2], u32x c[16], u32x d[16], __local u32 (*e)[64]) {
  u32x f;
...
void BY(u32x a, u32x b, u32x c[16], u32x d[16], __local u32 (*e)[64]) {
  u32x f;
...
__kernel void BZ(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  for (u32 as = 0; as < ab; as += 1) {
    ...
    for (u32 bm = 0, bn = 0; bm < av; bm += 8, bn++) {
      u32x bo[2];

      bo[0] = ((bi[bn] << 16) & 0xff000000) | ((bi[bn] << 8) & 0x0000ff00);
      bo[1] = ((bi[bn] >> 0) & 0xff000000) | ((bi[bn] >> 8) & 0x0000ff00);
    ...
    {
      const u32 bq[4] = {bl[0], bl[1], bpp, bpp};
      if (Z(bq, g, h, i, j, k, l, m, n, v, w, x)) {
        int br = X(bq, ac, &p[ad]);
        if (br != -1) {
          const u32 bs = ad + br;
          if (atomic_add(&q[bs], 1) == 0) {
            AA(o, t, y, br, bs, ag, as);
          }
        }
      }
    };
...
for (u32 at = 0; at < ab; at += 1) {
  ...
  for (u32 bn = 0, bo = 0; bn < aw; bn += 8, bo++) {
    u32x bp[2];

    bp[0] = ((bj[bo] << 16) & 0xff000000) | ((bj[bo] << 8) & 0x0000ff00);
    bp[1] = ((bj[bo] >> 0) & 0xff000000) | ((bj[bo] >> 8) & 0x0000ff00);
  ...
  {
    if (((bm[0]) == as[0]) && ((bm[1]) == as[1]) && ((bq) == as[2]) && ((bq) == as[3])) {
      const u32 br = ad + 0;
