...
inline void O(const mat4x4* a, const point4* b, point4* c);
inline void P(const global mat4x4* a, const point4* b, point4* c);
void Q(const global mat4x4* a, const point3* b, point3* c);
inline void R(const mat4x4* a, const vector4* b, vector4* c);
inline void S(const global mat4x4* a, const vector4* b, vector4* c);
inline void T(const global mat4x4* a, const vector3* b, vector3* c);
