...
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void L(__global Body* a, __global Shape* b, __global Constraint4* c, __global int* d, __global int* e, __global int* f, int g, int h, int4 i) {
  __local int j;
  __local int k;
  __local int l;
...
__kernel void M(__global Body* a, __global Shape* b, __global Constraint4* c, int d, int e, int f) {
