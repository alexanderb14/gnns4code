...
__kernel void EC(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global oldoffice01_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
  ...
  for (u32 ap = 0; ap < ab; ap += 1) {
    ...
    { const u32 ax[4] = { av0], av1], av2], av3] };
      if (Z(ax, g, h, i, j, k, l, m, n, v, w, x)) {
        int ay = X(ax, ac, &p[ad]);
        if (ay != -1) {
          const u32 az = ad + ay;
          if (atomic_add(&q[az], 1) == 0) {
            AA(o, t, y, ay, az, ah, ap);
          }
        }
      }
    };
...
for (u32 aq = 0; aq < ab; aq += 1) {
  ...
  {
    if (((aw[0]) == ap[0]) && ((aw[1]) == ap[1]) && ((aw[2]) == ap[2]) && ((aw[3]) == ap[3])) {
      const u32 ay = ad + 0;
      if (atomic_add(&q[ay], 1) == 0) {
        AA(o, t, y, 0, ay, ah, aq);
      }
    }
  };
