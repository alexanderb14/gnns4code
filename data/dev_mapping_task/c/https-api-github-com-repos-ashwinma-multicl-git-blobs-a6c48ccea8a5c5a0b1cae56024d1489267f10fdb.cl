__kernel void A(int a, int b, float c, __global int* d, __global float* e, __global int* f, __global float* g, __global float* h, __global float* i, __global float* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, __global float* q, __global float* r, int s, int t, __global float* u, __global float* v, __global float* w) {
  int x, y, z, aa;
  float ab, ac, ad;
  y = get_group_id(0) * get_local_size(0) + get_local_id(0) + d[2];
  x = get_group_id(1) * get_local_size(1) + get_local_id(1) + d[8];
  ...
  for (aa = 1; aa <= 3; aa++) {
    ...
    v[(z) + (a + 2) * ((x) + ((y) + 1) * (s + 3))] = v[(z) + (a + 2) * ((x) + ((y) + 1) * (s + 3))] +
  ...
  for (z = 3; z <= b; z++) {
    ...
    v[(z) + (a + 2) * ((x) + ((y) + 1) * (s + 3))] = v[(z) + (a + 2) * ((x) + ((y) + 1) * (s + 3))] +
                                                     0.5 * (e[(f[(z) + (a + 2) * ((x)-1 + ((y)-1) * (s + 1))]) - 1] + e[(f[(z) + (a + 2) * ((x)-1 + ((y + 1) - 1) * (s + 1))]) - 1]) * (j[((x)-1) * 4 + (1) - 1] * n[(z)-1 + a * ((x - 2) + 1 + ((y) + 1) * (s + 3))] + j[((x)-1) * 4 + (2) - 1] * n[(z)-1 + a * ((x - 1) + 1 + ((y) + 1) * (s + 3))] + j[((x)-1) * 4 + (3) - 1] * n[(z)-1 + a * ((x) + 1 + ((y) + 1) * (s + 3))] + j[((x)-1) * 4 + (4) - 1] * n[(z)-1 + a * ((x + 1) + 1 + ((y) + 1) * (s + 3))] +
                                                                                                                                                                                        h[((y)-1) * 4 + (1) - 1] * p[(z)-1 + a * (((x)-1) + (y - 1) * s)] + h[((y)-1) * 4 + (2) - 1] * p[(z)-1 + a * (((x)-1) + (y)*s)] + h[((y)-1) * 4 + (3) - 1] * p[(z)-1 + a * (((x)-1) + (y + 1) * s)] + h[((y)-1) * 4 + (4) - 1] * p[(z)-1 + a * (((x)-1) + (y + 2) * s)] +
                                                                                                                                                                                        i[((z)-1) * 4 + (1) - 1] * q[(z - 1) - 1 + (a + 1) * ((x)-1 + ((y) + 1) * s)] + i[((z)-1) * 4 + (2) - 1] * q[(z)-1 + (a + 1) * ((x)-1 + ((y) + 1) * s)] + i[((z)-1) * 4 + (3) - 1] * q[(z + 1) - 1 + (a + 1) * ((x)-1 + ((y) + 1) * s)] + i[((z)-1) * 4 + (4) - 1] * q[(z + 2) - 1 + (a + 1) * ((x)-1 + ((y) + 1) * s)]);

    w[(z) + (a + 2) * ((x) + (y) * (s + 3))] =
        w[(z) + (a + 2) * ((x) + (y) * (s + 3))] +
        0.5 * (e[(f[(z) + (a + 2) * ((x)-1 + ((y)-1) * (s + 1))]) - 1] + e[(f[(z - 1) + (a + 2) * ((x)-1 + ((y)-1) * (s + 1))]) - 1]) *
            (j[((x)-1) * 4 + (1) - 1] * o[(z)-1 + (a + 1) * ((x - 2) + 1 + ((y)-1) * (s + 3))] + j[((x)-1) * 4 + (2) - 1] * o[(z)-1 + (a + 1) * ((x - 1) + 1 + ((y)-1) * (s + 3))] + j[((x)-1) * 4 + (3) - 1] * o[(z)-1 + (a + 1) * ((x) + 1 + ((y)-1) * (s + 3))] + j[((x)-1) * 4 + (4) - 1] * o[(z)-1 + (a + 1) * ((x + 1) + 1 + ((y)-1) * (s + 3))] + k[((y)-1) * 4 + (1) - 1] * q[(z)-1 + (a + 1) * ((x)-1 + ((y - 2) + 1) * s)] + k[((y)-1) * 4 + (2) - 1] * q[(z)-1 + (a + 1) * ((x)-1 + ((y - 1) + 1) * s)] +
             k[((y)-1) * 4 + (3) - 1] * q[(z)-1 + (a + 1) * ((x)-1 + ((y) + 1) * s)] + k[((y)-1) * 4 + (4) - 1] * q[(z)-1 + (a + 1) * ((x)-1 + ((y + 1) + 1) * s)] + l[((z)-1) * 4 + (1) - 1] * r[(z - 2) - 1 + a * ((x)-1 + ((y)-1) * s)] + l[((z)-1) * 4 + (2) - 1] * r[(z - 1) - 1 + a * ((x)-1 + ((y)-1) * s)] + l[((z)-1) * 4 + (3) - 1] * r[(z)-1 + a * ((x)-1 + ((y)-1) * s)] + l[((z)-1) * 4 + (4) - 1] * r[(z + 1) - 1 + a * ((x)-1 + ((y)-1) * s)]);
  }
...
__kernel void B(float a, __global int* b, __global float* c, __global float* d, __global float* e, __global float* f, __global float* g, __global float* h, __global float* i, __global int* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, int q, int r, int s, __global float* t, __global float* u, __global float* v) {
  ...
  x = get_group_id(0) * get_local_size(0) + get_local_id(0) + b[2];
  w = get_group_id(1) * get_local_size(1) + get_local_id(1) + b[8];
...
__kernel void C(float a, int b, int c, __global int* d, __global float* e, __global float* f, __global float* g, __global float* h, __global int* i, __global float* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, __global float* q, __global float* r, __global float* s, __global float* t, __global float* u, int v, int w, int x, int y, int z, __global float* aa, __global float* ab, __global float* ac, __global float* ad,
  ...
  ah = get_group_id(0) * get_local_size(0) + get_local_id(0) + d[0];
  aj = get_group_id(1) * get_local_size(1) + get_local_id(1) + b;
  ...
  ak = 0;
  for (ai = b; ai < aj; ai++) {
    for (ag = d[6 + 4 * ai]; ag <= d[7 + 4 * ai]; ag++) {
      ak++;
    }
  }
  al = 0;
  ...
  for (ag = d[6 + 4 * aj]; ag <= d[7 + 4 * aj]; ag++) {
    ...
    for (ai = 1; ai <= z; ai++) {
      ...
      ax = aa[(ai) + (z + 2) * ((ag) + 1 + (ah) * (x + 3))] - ad[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))];
      ay = ab[(ai) + (z + 2) * ((ag) + ((ah) + 1) * (x + 3))] - ae[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))];
      az = ac[(ai) + (z + 2) * ((ag) + (ah) * (x + 3))] - af[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))];
      ...
      ad[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))] = ad[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))] * aq + ap * au * j[((ag)-1) * 4 + (2) - 1] / a * (p[(ai)-1 + z * ((ag) + ((ah)-1) * (x + 3))] - p[(ai)-1 + z * ((ag + 1) + ((ah)-1) * (x + 3))]);
      aa[(ai) + (z + 2) * ((ag) + 1 + (ah) * (x + 3))] = ax + ad[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))];

      ae[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))] = ae[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))] * as + ar * av * m[((ag)-1) * 4 + (2) - 1] / a * (q[(ai)-1 + z * ((ag - 1) + 1 + ((ah) + 1) * (x + 3))] - q[(ai)-1 + z * ((ag) + 1 + ((ah) + 1) * (x + 3))]);
      ab[(ai) + (z + 2) * ((ag) + ((ah) + 1) * (x + 3))] = ay + ae[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))];

      af[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))] = af[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))] * as + ar * aw * m[((ag)-1) * 4 + (2) - 1] / a * (r[(ai)-1 + (z + 1) * ((ag - 1) + 1 + ((ah)-1) * (x + 3))] - r[(ai)-1 + (z + 1) * ((ag) + 1 + ((ah)-1) * (x + 3))]);
      ac[(ai) + (z + 2) * ((ag) + (ah) * (x + 3))] = az + af[(ai)-1 + z * ((ak)-1 + bg * ((ah)-1))];
    }
  }
...
__kernel void D(int a, float b, int c, int d, __global int* e, __global float* f, __global float* g, __global float* h, __global int* i, __global float* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, __global float* q, __global float* r, __global float* s, __global float* t, __global float* u, __global float* v, int w, int x, int y, int z, __global float* aa, __global float* ab, __global float* ac, __global float* ad,
  ...
  aj = get_local_size(0) * get_group_id(0) + get_local_id(0) + c;
  ag = get_local_size(1) * get_group_id(1) + get_local_id(1) + e[6];
...
__kernel void E(int a, float b, int c, int d, __global int* e, __global float* f, __global float* g, __global float* h, __global float* i, __global int* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, __global float* q, __global float* r, __global float* s, __global float* t, __global float* u, __global float* v, int w, int x, int y, int z, int aa, __global float* ab, __global float* ac, __global float* ad, __global float* ae,
  ...
  ai = get_group_id(0) * get_local_size(0) + get_local_id(0) + e[0];
  ak = get_group_id(1) * get_local_size(1) + get_local_id(1) + c;
  ...
  al = 0;
  for (aj = c; aj < ak; aj++) {
    for (ah = e[6 + 4 * aj]; ah <= e[7 + 4 * aj]; ah++) {
      al++;
    }
  }
  am = 0;
...
__kernel void F(int a, float b, int c, int d, __global int* e, __global float* f, __global float* g, __global float* h, __global float* i, __global int* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, __global float* q, __global float* r, __global float* s, __global float* t, __global float* u, __global float* v, int w, int x, int y, int z, int aa, __global float* ab, __global float* ac, __global float* ad, __global float* ae,
  ...
  ak = get_group_id(0) * get_local_size(0) + get_local_id(0) + c;
  ah = get_group_id(1) * get_local_size(1) + get_local_id(1) + e[6];
...
__kernel void G(int a, float b, __global int* c, __global float* d, __global float* e, __global float* f, __global float* g, __global int* h, __global float* i, __global float* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, __global float* q, __global float* r, __global float* s, __global float* t, int u, int v, int w, int x, int y, __global float* z, __global float* aa, __global float* ab, __global float* ac,
  ...
  ag = get_group_id(0) * get_local_size(0) + get_local_id(0) + c[0];
  af = get_group_id(1) * get_local_size(1) + get_local_id(1) + c[6];
...
__kernel void H(int a, int b, int c, int d, __global int* e, __global int* f, float g, __global float* h, __global float* i, __global float* j, __global float* k, __global float* l, __global float* m, __global float* n, __global float* o, __global float* p, __global float* q, __global float* r, __global float* s, __global float* t, __global float* u, __global float* v, __global float* w, __global float* x, __global float* y, __global float* z, __global float* aa, __global float* ab,
  ...
  af = get_group_id(0) * get_local_size(0) + get_local_id(0) + e[2];
  ae = get_group_id(1) * get_local_size(1) + get_local_id(1) + e[8];
...

{
  ...
  y = get_group_id(0) * get_local_size(0) + get_local_id(0) + f[2];
  x = get_group_id(1) * get_local_size(1) + get_local_id(1) + f[8];
...

{
  ...
  am = get_group_id(0) * get_local_size(0) + get_local_id(0) + j[0];
  ao = get_group_id(1) * get_local_size(1) + get_local_id(1) + h;
  ...
  ap = 0;
  for (an = h; an < ao; an++) {
    for (al = j[6 + 4 * an]; al <= j[7 + 4 * an]; al++)
      ap++;
  }
...

{
  ...
  aj = get_group_id(0) * get_local_size(0) + get_local_id(0) + h[6];
  am = get_group_id(1) * get_local_size(1) + get_local_id(1) + f;
  if (aj > h[11] || am > g) {
    return;
  }
...

{
  ...
  ac = get_group_id(0) * get_local_size(0) + get_local_id(0) + j[0];
  ae = get_group_id(1) * get_local_size(1) + get_local_id(1) + h;
  if (ac > j[5] || ae > i) {
    return;
  }
  ...
  af = 0;
  for (ad = h; ad < ae; ad++) {
    for (ab = j[6 + 4 * ad]; ab <= j[7 + 4 * ad]; ab++) {
      af++;
    }
  }
...

{
  ...
  z = get_group_id(0) * get_local_size(0) + get_local_id(0) + h[6];
  ac = get_group_id(1) * get_local_size(1) + get_local_id(1) + f;
...

{
  ...
  u = get_group_id(0) * get_local_size(0) + get_local_id(0) + g[8];
  x = get_group_id(1) * get_local_size(1) + get_local_id(1) + e;
...

{
  ...
  v = get_group_id(0) * get_local_size(0) + get_local_id(0) + g[2];
  x = get_group_id(1) * get_local_size(1) + get_local_id(1) + e;
...

{
  ...
  af = get_group_id(0) * get_local_size(0) + get_local_id(0) + f[2];
  ae = get_group_id(1) * get_local_size(1) + get_local_id(1) + f[8];
...

{
  ...
  x = get_group_id(0) * get_local_size(0) + get_local_id(0) + f[2];
  w = get_group_id(1) * get_local_size(1) + get_local_id(1) + f[8];
...

{
  ...
  an = get_group_id(0) * get_local_size(0) + get_local_id(0) + k[0];
  ap = get_group_id(1) * get_local_size(1) + get_local_id(1) + i;
  ...
  aq = 0;
  for (ao = i; ao < ap; ao++) {
    for (am = k[6 + 4 * ao]; am <= k[7 + 4 * ao]; am++) {
      aq++;
    }
  }
...

{
  ...
  ak = get_group_id(0) * get_local_size(0) + get_local_id(0) + i[6];
  an = get_group_id(1) * get_local_size(1) + get_local_id(1) + g;
...

{
  ...
  ak = get_group_id(0) * get_local_size(0) + get_local_id(0) + h[0];
  aj = get_group_id(1) * get_local_size(1) + get_local_id(1) + h[6];
...

{
  ...
  ad = get_group_id(0) * get_local_size(0) + get_local_id(0) + k[0];
  af = get_group_id(1) * get_local_size(1) + get_local_id(1) + i;
  ...
  ag = 0;
  for (ae = i; ae < af; ae++) {
    for (ac = k[6 + 4 * ae]; ac <= k[7 + 4 * ae]; ac++) {
      ag++;
    }
  }
...

{
  ...
  aa = get_group_id(0) * get_local_size(0) + get_local_id(0) + i[6];
  ad = get_group_id(1) * get_local_size(1) + get_local_id(1) + g;
...

{
  ...
  t = get_group_id(0) * get_local_size(0) + get_local_id(0) + f[2];
  s = get_group_id(1) * get_local_size(1) + get_local_id(1) + f[8];
...

{
  ...
  u = get_group_id(0) * get_local_size(0) + get_local_id(0) + h[8];
  x = get_group_id(1) * get_local_size(1) + get_local_id(1) + f;
...

{
  ...
  z = get_group_id(0) * get_local_size(0) + get_local_id(0) + g[0];
...

{
  ...
  v = get_group_id(0) * get_local_size(0) + get_local_id(0) + h[2];
  x = get_group_id(1) * get_local_size(1) + get_local_id(1) + f;
