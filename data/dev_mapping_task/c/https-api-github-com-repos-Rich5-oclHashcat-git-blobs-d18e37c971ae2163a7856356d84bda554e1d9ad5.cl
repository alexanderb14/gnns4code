...
inline void W(u32 a[4], u32 b[4], u32 c[4], u32 d[4], const u32 e) {
  const int f = e & 3;
...
__kernel void X(__global pw_t* a, __global pw_t* b, __global kernel_rule_t* c, __global comb_t* d, __global bf_t* e, const u32 f, const u32 g) {
