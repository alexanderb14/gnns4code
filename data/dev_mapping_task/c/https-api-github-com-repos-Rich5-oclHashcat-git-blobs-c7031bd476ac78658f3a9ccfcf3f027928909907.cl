...
void CC(const u32x a[16], const u32 b, u32x c[4], __local u32* d) {
  u32x e[4];
...
__kernel void CD(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  for (u32 at = 0; at < ab; at += 1) {
    ...
    const u32x bk = (u32x)(al[((bj[0] >> 0) & 255)]) << 0 | (u32x)(al[((bj[0] >> 8) & 255)]) << 16;
    const u32x bl = (u32x)(al[((bj[0] >> 16) & 255)]) << 0 | (u32x)(al[((bj[0] >> 24) & 255)]) << 16;
    const u32x bm = (u32x)(al[((bj[1] >> 0) & 255)]) << 0 | (u32x)(al[((bj[1] >> 8) & 255)]) << 16;
    const u32x bn = (u32x)(al[((bj[1] >> 16) & 255)]) << 0 | (u32x)(al[((bj[1] >> 24) & 255)]) << 16;
    const u32x bo = (u32x)(al[((bj[2] >> 0) & 255)]) << 0 | (u32x)(al[((bj[2] >> 8) & 255)]) << 16;
    const u32x bp = (u32x)(al[((bj[2] >> 16) & 255)]) << 0 | (u32x)(al[((bj[2] >> 24) & 255)]) << 16;
    const u32x bq = (u32x)(al[((bj[3] >> 0) & 255)]) << 0 | (u32x)(al[((bj[3] >> 8) & 255)]) << 16;

    const u32 br = 0x0e0e0e0e;
    ...
    u32x bs = bj[0] & 0xffffffff;
    u32x bt = bj[1] & 0xffffffff;
    u32x bu = bj[2] & 0x000000ff;
    u32x bv = bj[3] & 0x00000000;

    {
      const u32 bw[4] = {bss, btt, buu, bvv};
      if (Z(bw, g, h, i, j, k, l, m, n, v, w, x)) {
        int bx = X(bw, ac, &p[ad]);
        if (bx != -1) {
          const u32 by = ad + bx;
          if (atomic_add(&q[by], 1) == 0) {
            AA(o, t, y, bx, by, ag, at);
          }
        }
      }
    };
...
for (u32 au = 0; au < ab; au += 1) {
  ...
  const u32x bl = (u32x)(al[((bk[0] >> 0) & 255)]) << 0 | (u32x)(al[((bk[0] >> 8) & 255)]) << 16;
  const u32x bm = (u32x)(al[((bk[0] >> 16) & 255)]) << 0 | (u32x)(al[((bk[0] >> 24) & 255)]) << 16;
  const u32x bn = (u32x)(al[((bk[1] >> 0) & 255)]) << 0 | (u32x)(al[((bk[1] >> 8) & 255)]) << 16;
  const u32x bo = (u32x)(al[((bk[1] >> 16) & 255)]) << 0 | (u32x)(al[((bk[1] >> 24) & 255)]) << 16;
  const u32x bp = (u32x)(al[((bk[2] >> 0) & 255)]) << 0 | (u32x)(al[((bk[2] >> 8) & 255)]) << 16;
  const u32x bq = (u32x)(al[((bk[2] >> 16) & 255)]) << 0 | (u32x)(al[((bk[2] >> 24) & 255)]) << 16;
  const u32x br = (u32x)(al[((bk[3] >> 0) & 255)]) << 0 | (u32x)(al[((bk[3] >> 8) & 255)]) << 16;

  const u32 bs = 0x0e0e0e0e;
  ...
  u32x bt = bk[0] & 0xffffffff;
  u32x bu = bk[1] & 0xffffffff;
  u32x bv = bk[2] & 0x000000ff;
  u32x bw = bk[3] & 0x00000000;

  {
    if (((bt) == at[0]) && ((bu) == at[1]) && ((bv) == at[2]) && ((bw) == at[3])) {
      const u32 bx = ad + 0;
