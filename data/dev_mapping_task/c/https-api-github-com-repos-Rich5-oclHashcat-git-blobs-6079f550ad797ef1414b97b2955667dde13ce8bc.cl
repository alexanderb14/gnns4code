...
__constant u32 Gb[4][256] = {{0xBCBC3275, 0xECEC21F3, 0x202043C6, 0xB3B3C9F4, 0xDADA03DB, 0x02028B7B, 0xE2E22BFB, 0x9E9EFAC8, 0xC9C9EC4A, 0xD4D409D3, 0x18186BE6, 0x1E1E9F6B, 0x98980E45, 0xB2B2387D, 0xA6A6D2E8, 0x2626B74B, 0x3C3C57D6, 0x93938A32, 0x8282EED8, 0x525298FD, 0x7B7BD437, 0xBBBB3771, 0x5B5B97F1, 0x474783E1, 0x24243C30, 0x5151E20F, 0xBABAC6F8, 0x4A4AF31B, 0xBFBF4887, 0x0D0D70FA, 0xB0B0B306, 0x7575DE3F, 0xD2D2FD5E, 0x7D7D20BA, 0x666631AE, 0x3A3AA35B, 0x59591C8A,
...
u32 BU(u32* a, u32* b, const u32 c, const u32* d) {
  u32 e, f, g, h;
  ...
  e = Ga[1][e] ^ (((d[3]) >> (8 * (0))) & 0xff);
  f = Ga[0][f] ^ (((d[3]) >> (8 * (1))) & 0xff);
  g = Ga[0][g] ^ (((d[3]) >> (8 * (2))) & 0xff);
  h = Ga[1][h] ^ (((d[3]) >> (8 * (3))) & 0xff);

  e = Ga[1][e] ^ (((d[2]) >> (8 * (0))) & 0xff);
  f = Ga[1][f] ^ (((d[2]) >> (8 * (1))) & 0xff);
  g = Ga[0][g] ^ (((d[2]) >> (8 * (2))) & 0xff);
  h = Ga[0][h] ^ (((d[2]) >> (8 * (3))) & 0xff);

  e = Ga[0][(Ga[0][e] ^ (((d[1]) >> (8 * (0))) & 0xff))] ^ (((d[0]) >> (8 * (0))) & 0xff);
  f = Ga[0][(Ga[1][f] ^ (((d[1]) >> (8 * (1))) & 0xff))] ^ (((d[0]) >> (8 * (1))) & 0xff);
  g = Ga[1][(Ga[0][g] ^ (((d[1]) >> (8 * (2))) & 0xff))] ^ (((d[0]) >> (8 * (2))) & 0xff);
  h = Ga[1][(Ga[1][h] ^ (((d[1]) >> (8 * (3))) & 0xff))] ^ (((d[0]) >> (8 * (3))) & 0xff);

  return Gb[0][e] ^ Gb[1][f] ^ Gb[2][g] ^ Gb[3][h];
}
u32 BV(u32 a, u32 b) {
  for (int c = 0; c < 8; c++) {
    u32 d = b >> 24;
...
void BW(u32* a, u32* b, const u32* c) {
  u32 d[4];
...
void BX(const u32* a, const u32* b, const u32* c, u32* d) {
  u32 e[4];
  ...
  {
    u32 f = (Gb[0][Ga[0][Ga[0][Ga[1][Ga[1][(((e[0]) >> (8 * (0))) & 0xff)] ^ (((a[3]) >> (8 * (0))) & 0xff)] ^ (((a[2]) >> (8 * (0))) & 0xff)] ^ (((a[1]) >> (8 * (0))) & 0xff)] ^ (((a[0]) >> (8 * (0))) & 0xff)] ^ Gb[1][Ga[0][Ga[1][Ga[1][Ga[0][(((e[0]) >> (8 * (1))) & 0xff)] ^ (((a[3]) >> (8 * (1))) & 0xff)] ^ (((a[2]) >> (8 * (1))) & 0xff)] ^ (((a[1]) >> (8 * (1))) & 0xff)] ^ (((a[0]) >> (8 * (1))) & 0xff)] ^
             Gb[2][Ga[1][Ga[0][Ga[0][Ga[0][(((e[0]) >> (8 * (2))) & 0xff)] ^ (((a[3]) >> (8 * (2))) & 0xff)] ^ (((a[2]) >> (8 * (2))) & 0xff)] ^ (((a[1]) >> (8 * (2))) & 0xff)] ^ (((a[0]) >> (8 * (2))) & 0xff)] ^ Gb[3][Ga[1][Ga[1][Ga[0][Ga[1][(((e[0]) >> (8 * (3))) & 0xff)] ^ (((a[3]) >> (8 * (3))) & 0xff)] ^ (((a[2]) >> (8 * (3))) & 0xff)] ^ (((a[1]) >> (8 * (3))) & 0xff)] ^ (((a[0]) >> (8 * (3))) & 0xff)]);
    u32 g = (Gb[0][Ga[0][Ga[0][Ga[1][Ga[1][(((e[1]) >> (8 * (3))) & 0xff)] ^ (((a[3]) >> (8 * (0))) & 0xff)] ^ (((a[2]) >> (8 * (0))) & 0xff)] ^ (((a[1]) >> (8 * (0))) & 0xff)] ^ (((a[0]) >> (8 * (0))) & 0xff)] ^ Gb[1][Ga[0][Ga[1][Ga[1][Ga[0][(((e[1]) >> (8 * (0))) & 0xff)] ^ (((a[3]) >> (8 * (1))) & 0xff)] ^ (((a[2]) >> (8 * (1))) & 0xff)] ^ (((a[1]) >> (8 * (1))) & 0xff)] ^ (((a[0]) >> (8 * (1))) & 0xff)] ^
             Gb[2][Ga[1][Ga[0][Ga[0][Ga[0][(((e[1]) >> (8 * (1))) & 0xff)] ^ (((a[3]) >> (8 * (2))) & 0xff)] ^ (((a[2]) >> (8 * (2))) & 0xff)] ^ (((a[1]) >> (8 * (2))) & 0xff)] ^ (((a[0]) >> (8 * (2))) & 0xff)] ^ Gb[3][Ga[1][Ga[1][Ga[0][Ga[1][(((e[1]) >> (8 * (2))) & 0xff)] ^ (((a[3]) >> (8 * (3))) & 0xff)] ^ (((a[2]) >> (8 * (3))) & 0xff)] ^ (((a[1]) >> (8 * (3))) & 0xff)] ^ (((a[0]) >> (8 * (3))) & 0xff)]);
    e[2] = O(e[2] ^ (f + g + b[4 * (0) + 8]), 1);
    e[3] = P(e[3], 1) ^ (f + 2 * g + b[4 * (0) + 9]);
    u32 h = (Gb[0][Ga[0][Ga[0][Ga[1][Ga[1][(((e[2]) >> (8 * (0))) & 0xff)] ^ (((a[3]) >> (8 * (0))) & 0xff)] ^ (((a[2]) >> (8 * (0))) & 0xff)] ^ (((a[1]) >> (8 * (0))) & 0xff)] ^ (((a[0]) >> (8 * (0))) & 0xff)] ^ Gb[1][Ga[0][Ga[1][Ga[1][Ga[0][(((e[2]) >> (8 * (1))) & 0xff)] ^ (((a[3]) >> (8 * (1))) & 0xff)] ^ (((a[2]) >> (8 * (1))) & 0xff)] ^ (((a[1]) >> (8 * (1))) & 0xff)] ^ (((a[0]) >> (8 * (1))) & 0xff)] ^
             Gb[2][Ga[1][Ga[0][Ga[0][Ga[0][(((e[2]) >> (8 * (2))) & 0xff)] ^ (((a[3]) >> (8 * (2))) & 0xff)] ^ (((a[2]) >> (8 * (2))) & 0xff)] ^ (((a[1]) >> (8 * (2))) & 0xff)] ^ (((a[0]) >> (8 * (2))) & 0xff)] ^ Gb[3][Ga[1][Ga[1][Ga[0][Ga[1][(((e[2]) >> (8 * (3))) & 0xff)] ^ (((a[3]) >> (8 * (3))) & 0xff)] ^ (((a[2]) >> (8 * (3))) & 0xff)] ^ (((a[1]) >> (8 * (3))) & 0xff)] ^ (((a[0]) >> (8 * (3))) & 0xff)]);
    u32 i = (Gb[0][Ga[0][Ga[0][Ga[1][Ga[1][(((e[3]) >> (8 * (3))) & 0xff)] ^ (((a[3]) >> (8 * (0))) & 0xff)] ^ (((a[2]) >> (8 * (0))) & 0xff)] ^ (((a[1]) >> (8 * (0))) & 0xff)] ^ (((a[0]) >> (8 * (0))) & 0xff)] ^ Gb[1][Ga[0][Ga[1][Ga[1][Ga[0][(((e[3]) >> (8 * (0))) & 0xff)] ^ (((a[3]) >> (8 * (1))) & 0xff)] ^ (((a[2]) >> (8 * (1))) & 0xff)] ^ (((a[1]) >> (8 * (1))) & 0xff)] ^ (((a[0]) >> (8 * (1))) & 0xff)] ^
             Gb[2][Ga[1][Ga[0][Ga[0][Ga[0][(((e[3]) >> (8 * (1))) & 0xff)] ^ (((a[3]) >> (8 * (2))) & 0xff)] ^ (((a[2]) >> (8 * (2))) & 0xff)] ^ (((a[1]) >> (8 * (2))) & 0xff)] ^ (((a[0]) >> (8 * (2))) & 0xff)] ^ Gb[3][Ga[1][Ga[1][Ga[0][Ga[1][(((e[3]) >> (8 * (2))) & 0xff)] ^ (((a[3]) >> (8 * (3))) & 0xff)] ^ (((a[2]) >> (8 * (3))) & 0xff)] ^ (((a[1]) >> (8 * (3))) & 0xff)] ^ (((a[0]) >> (8 * (3))) & 0xff)]);
...
void BY(const u32* a, const u32* b, const u32* c, u32* d) {
  u32 e[4];
...
void BZ(const u32* a, const u32* b, const u32* c, u32* d) {
  u32 e[4] = {0};
  u32 f[4] = {0};
...
void CA(u32* a, u32* b, __local u32* c, __local u32* d, __local u32* e, __local u32* f, __local u32* g) {
  b[0] = a[0];
  b[1] = a[1];
  b[2] = a[2];
  b[3] = a[3];
  ...
  while (j) {
    ...
    b[i + 8] = b[i + 0] ^ (e[(k >> 16) & 0xff] & 0xff000000) ^ (f[(k >> 8) & 0xff] & 0x00ff0000) ^ (c[(k >> 0) & 0xff] & 0x0000ff00) ^ (d[(k >> 24) & 0xff] & 0x000000ff) ^ Gm[h];
...
void CB(u32* a, __local u32* b, __local u32* c, __local u32* d, __local u32* e, __local u32* f, __local u32* g, __local u32* h, __local u32* i, __local u32* j, __local u32* k) {
...
void CC(const u32* a, u32* b, const u32* c, __local u32* d, __local u32* e, __local u32* f, __local u32* g, __local u32* h) {
  u32 i = a[0] ^ c[0];
  u32 j = a[1] ^ c[1];
  u32 k = a[2] ^ c[2];
  u32 l = a[3] ^ c[3];
...
void CD(const u32* a, u32* b, const u32* c, __local u32* d, __local u32* e, __local u32* f, __local u32* g, __local u32* h) {
  u32 i = a[0] ^ c[0];
  u32 j = a[1] ^ c[1];
  u32 k = a[2] ^ c[2];
  u32 l = a[3] ^ c[3];
  ...
  m = d[i >> 24] ^ e[(j >> 16) & 0xff] ^ f[(k >> 8) & 0xff] ^ g[l & 0xff] ^ c[4];
  n = d[j >> 24] ^ e[(k >> 16) & 0xff] ^ f[(l >> 8) & 0xff] ^ g[i & 0xff] ^ c[5];
  o = d[k >> 24] ^ e[(l >> 16) & 0xff] ^ f[(i >> 8) & 0xff] ^ g[j & 0xff] ^ c[6];
  p = d[l >> 24] ^ e[(i >> 16) & 0xff] ^ f[(j >> 8) & 0xff] ^ g[k & 0xff] ^ c[7];
  i = d[m >> 24] ^ e[(n >> 16) & 0xff] ^ f[(o >> 8) & 0xff] ^ g[p & 0xff] ^ c[8];
  j = d[n >> 24] ^ e[(o >> 16) & 0xff] ^ f[(p >> 8) & 0xff] ^ g[m & 0xff] ^ c[9];
  k = d[o >> 24] ^ e[(p >> 16) & 0xff] ^ f[(m >> 8) & 0xff] ^ g[n & 0xff] ^ c[10];
  l = d[p >> 24] ^ e[(m >> 16) & 0xff] ^ f[(n >> 8) & 0xff] ^ g[o & 0xff] ^ c[11];
  m = d[i >> 24] ^ e[(j >> 16) & 0xff] ^ f[(k >> 8) & 0xff] ^ g[l & 0xff] ^ c[12];
  n = d[j >> 24] ^ e[(k >> 16) & 0xff] ^ f[(l >> 8) & 0xff] ^ g[i & 0xff] ^ c[13];
  o = d[k >> 24] ^ e[(l >> 16) & 0xff] ^ f[(i >> 8) & 0xff] ^ g[j & 0xff] ^ c[14];
  p = d[l >> 24] ^ e[(i >> 16) & 0xff] ^ f[(j >> 8) & 0xff] ^ g[k & 0xff] ^ c[15];
  i = d[m >> 24] ^ e[(n >> 16) & 0xff] ^ f[(o >> 8) & 0xff] ^ g[p & 0xff] ^ c[16];
  j = d[n >> 24] ^ e[(o >> 16) & 0xff] ^ f[(p >> 8) & 0xff] ^ g[m & 0xff] ^ c[17];
  k = d[o >> 24] ^ e[(p >> 16) & 0xff] ^ f[(m >> 8) & 0xff] ^ g[n & 0xff] ^ c[18];
  l = d[p >> 24] ^ e[(m >> 16) & 0xff] ^ f[(n >> 8) & 0xff] ^ g[o & 0xff] ^ c[19];
  m = d[i >> 24] ^ e[(j >> 16) & 0xff] ^ f[(k >> 8) & 0xff] ^ g[l & 0xff] ^ c[20];
  n = d[j >> 24] ^ e[(k >> 16) & 0xff] ^ f[(l >> 8) & 0xff] ^ g[i & 0xff] ^ c[21];
  o = d[k >> 24] ^ e[(l >> 16) & 0xff] ^ f[(i >> 8) & 0xff] ^ g[j & 0xff] ^ c[22];
  p = d[l >> 24] ^ e[(i >> 16) & 0xff] ^ f[(j >> 8) & 0xff] ^ g[k & 0xff] ^ c[23];
  i = d[m >> 24] ^ e[(n >> 16) & 0xff] ^ f[(o >> 8) & 0xff] ^ g[p & 0xff] ^ c[24];
  j = d[n >> 24] ^ e[(o >> 16) & 0xff] ^ f[(p >> 8) & 0xff] ^ g[m & 0xff] ^ c[25];
  k = d[o >> 24] ^ e[(p >> 16) & 0xff] ^ f[(m >> 8) & 0xff] ^ g[n & 0xff] ^ c[26];
  l = d[p >> 24] ^ e[(m >> 16) & 0xff] ^ f[(n >> 8) & 0xff] ^ g[o & 0xff] ^ c[27];
  m = d[i >> 24] ^ e[(j >> 16) & 0xff] ^ f[(k >> 8) & 0xff] ^ g[l & 0xff] ^ c[28];
  n = d[j >> 24] ^ e[(k >> 16) & 0xff] ^ f[(l >> 8) & 0xff] ^ g[i & 0xff] ^ c[29];
  o = d[k >> 24] ^ e[(l >> 16) & 0xff] ^ f[(i >> 8) & 0xff] ^ g[j & 0xff] ^ c[30];
  p = d[l >> 24] ^ e[(i >> 16) & 0xff] ^ f[(j >> 8) & 0xff] ^ g[k & 0xff] ^ c[31];
  i = d[m >> 24] ^ e[(n >> 16) & 0xff] ^ f[(o >> 8) & 0xff] ^ g[p & 0xff] ^ c[32];
  j = d[n >> 24] ^ e[(o >> 16) & 0xff] ^ f[(p >> 8) & 0xff] ^ g[m & 0xff] ^ c[33];
  k = d[o >> 24] ^ e[(p >> 16) & 0xff] ^ f[(m >> 8) & 0xff] ^ g[n & 0xff] ^ c[34];
  l = d[p >> 24] ^ e[(m >> 16) & 0xff] ^ f[(n >> 8) & 0xff] ^ g[o & 0xff] ^ c[35];
  m = d[i >> 24] ^ e[(j >> 16) & 0xff] ^ f[(k >> 8) & 0xff] ^ g[l & 0xff] ^ c[36];
  n = d[j >> 24] ^ e[(k >> 16) & 0xff] ^ f[(l >> 8) & 0xff] ^ g[i & 0xff] ^ c[37];
  o = d[k >> 24] ^ e[(l >> 16) & 0xff] ^ f[(i >> 8) & 0xff] ^ g[j & 0xff] ^ c[38];
  p = d[l >> 24] ^ e[(i >> 16) & 0xff] ^ f[(j >> 8) & 0xff] ^ g[k & 0xff] ^ c[39];
  i = d[m >> 24] ^ e[(n >> 16) & 0xff] ^ f[(o >> 8) & 0xff] ^ g[p & 0xff] ^ c[40];
  j = d[n >> 24] ^ e[(o >> 16) & 0xff] ^ f[(p >> 8) & 0xff] ^ g[m & 0xff] ^ c[41];
  k = d[o >> 24] ^ e[(p >> 16) & 0xff] ^ f[(m >> 8) & 0xff] ^ g[n & 0xff] ^ c[42];
  l = d[p >> 24] ^ e[(m >> 16) & 0xff] ^ f[(n >> 8) & 0xff] ^ g[o & 0xff] ^ c[43];
  m = d[i >> 24] ^ e[(j >> 16) & 0xff] ^ f[(k >> 8) & 0xff] ^ g[l & 0xff] ^ c[44];
  n = d[j >> 24] ^ e[(k >> 16) & 0xff] ^ f[(l >> 8) & 0xff] ^ g[i & 0xff] ^ c[45];
  o = d[k >> 24] ^ e[(l >> 16) & 0xff] ^ f[(i >> 8) & 0xff] ^ g[j & 0xff] ^ c[46];
  p = d[l >> 24] ^ e[(i >> 16) & 0xff] ^ f[(j >> 8) & 0xff] ^ g[k & 0xff] ^ c[47];
  i = d[m >> 24] ^ e[(n >> 16) & 0xff] ^ f[(o >> 8) & 0xff] ^ g[p & 0xff] ^ c[48];
  j = d[n >> 24] ^ e[(o >> 16) & 0xff] ^ f[(p >> 8) & 0xff] ^ g[m & 0xff] ^ c[49];
  k = d[o >> 24] ^ e[(p >> 16) & 0xff] ^ f[(m >> 8) & 0xff] ^ g[n & 0xff] ^ c[50];
  l = d[p >> 24] ^ e[(m >> 16) & 0xff] ^ f[(n >> 8) & 0xff] ^ g[o & 0xff] ^ c[51];
  m = d[i >> 24] ^ e[(j >> 16) & 0xff] ^ f[(k >> 8) & 0xff] ^ g[l & 0xff] ^ c[52];
  n = d[j >> 24] ^ e[(k >> 16) & 0xff] ^ f[(l >> 8) & 0xff] ^ g[i & 0xff] ^ c[53];
  o = d[k >> 24] ^ e[(l >> 16) & 0xff] ^ f[(i >> 8) & 0xff] ^ g[j & 0xff] ^ c[54];
  p = d[l >> 24] ^ e[(i >> 16) & 0xff] ^ f[(j >> 8) & 0xff] ^ g[k & 0xff] ^ c[55];

  b[0] = (h[(m >> 24) & 0xff] & 0xff000000) ^ (h[(n >> 16) & 0xff] & 0x00ff0000) ^ (h[(o >> 8) & 0xff] & 0x0000ff00) ^ (h[(p >> 0) & 0xff] & 0x000000ff) ^ c[56];

  b[1] = (h[(n >> 24) & 0xff] & 0xff000000) ^ (h[(o >> 16) & 0xff] & 0x00ff0000) ^ (h[(p >> 8) & 0xff] & 0x0000ff00) ^ (h[(m >> 0) & 0xff] & 0x000000ff) ^ c[57];

  b[2] = (h[(o >> 24) & 0xff] & 0xff000000) ^ (h[(p >> 16) & 0xff] & 0x00ff0000) ^ (h[(m >> 8) & 0xff] & 0x0000ff00) ^ (h[(n >> 0) & 0xff] & 0x000000ff) ^ c[58];

  b[3] = (h[(p >> 24) & 0xff] & 0xff000000) ^ (h[(m >> 16) & 0xff] & 0x00ff0000) ^ (h[(n >> 8) & 0xff] & 0x0000ff00) ^ (h[(o >> 0) & 0xff] & 0x000000ff) ^ c[59];
}

__constant u32 Gn[64] = {
...
void CE(const u32 a[4], const u32 b[4], const u32 c[4], const u32 d[4], u32 e[8]) {
  u32 f = e[0];
  u32 g = e[1];
  u32 h = e[2];
  u32 i = e[3];
  ...
  {
    {
      m += Gn[0 + 0];
      m += n;
      m += (P((j), 26u) ^ P((j), 21u) ^ P((j), 7u));
      m += ((((l)) ^ (((j)) & (((k)) ^ ((l))))));
      i += m;
      m += (P((f), 30u) ^ P((f), 19u) ^ P((f), 10u));
      m += (((((f)) & ((g))) | (((h)) & (((f)) ^ ((g))))));
    };
    {
      l += Gn[0 + 1];
      l += o;
      l += (P((i), 26u) ^ P((i), 21u) ^ P((i), 7u));
      l += ((((k)) ^ (((i)) & (((j)) ^ ((k))))));
      h += l;
      l += (P((m), 30u) ^ P((m), 19u) ^ P((m), 10u));
      l += (((((m)) & ((f))) | (((g)) & (((m)) ^ ((f))))));
    };
    {
      k += Gn[0 + 2];
      k += p;
      k += (P((h), 26u) ^ P((h), 21u) ^ P((h), 7u));
      k += ((((j)) ^ (((h)) & (((i)) ^ ((j))))));
      g += k;
      k += (P((l), 30u) ^ P((l), 19u) ^ P((l), 10u));
      k += (((((l)) & ((m))) | (((f)) & (((l)) ^ ((m))))));
    };
    {
      j += Gn[0 + 3];
  ...
  for (int ad = 16; ad < 64; ad += 16) {
    {
      n = ((P((ab), 15u) ^ P((ab), 13u) ^ (((ab)) >> (10u))) + w + (P((o), 25u) ^ P((o), 14u) ^ (((o)) >> (3u))) + n);
      o = ((P((ac), 15u) ^ P((ac), 13u) ^ (((ac)) >> (10u))) + x + (P((p), 25u) ^ P((p), 14u) ^ (((p)) >> (3u))) + o);
      p = ((P((n), 15u) ^ P((n), 13u) ^ (((n)) >> (10u))) + y + (P((q), 25u) ^ P((q), 14u) ^ (((q)) >> (3u))) + p);
      q = ((P((o), 15u) ^ P((o), 13u) ^ (((o)) >> (10u))) + z + (P((r), 25u) ^ P((r), 14u) ^ (((r)) >> (3u))) + q);
      r = ((P((p), 15u) ^ P((p), 13u) ^ (((p)) >> (10u))) + aa + (P((s), 25u) ^ P((s), 14u) ^ (((s)) >> (3u))) + r);
      s = ((P((q), 15u) ^ P((q), 13u) ^ (((q)) >> (10u))) + ab + (P((t), 25u) ^ P((t), 14u) ^ (((t)) >> (3u))) + s);
      t = ((P((r), 15u) ^ P((r), 13u) ^ (((r)) >> (10u))) + ac + (P((u), 25u) ^ P((u), 14u) ^ (((u)) >> (3u))) + t);
      ...
      z = ((P((x), 15u) ^ P((x), 13u) ^ (((x)) >> (10u))) + s + (P((aa), 25u) ^ P((aa), 14u) ^ (((aa)) >> (3u))) + z);
      aa = ((P((y), 15u) ^ P((y), 13u) ^ (((y)) >> (10u))) + t + (P((ab), 25u) ^ P((ab), 14u) ^ (((ab)) >> (3u))) + aa);
      ab = ((P((z), 15u) ^ P((z), 13u) ^ (((z)) >> (10u))) + u + (P((ac), 25u) ^ P((ac), 14u) ^ (((ac)) >> (3u))) + ab);
      ac = ((P((aa), 15u) ^ P((aa), 13u) ^ (((aa)) >> (10u))) + v + (P((n), 25u) ^ P((n), 14u) ^ (((n)) >> (3u))) + ac);
    };
    {
      {
        m += Gn[ad + 0];
...
__kernel void CF(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global keepass_tmp_t* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global keepass_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
  ...
  if (s[y].version == 2 && s[y].keyfile_len == 0) {
    ah[0] = am[0];
    ah[1] = am[1];
    ah[2] = am[2];
    ah[3] = am[3];
  ...
  e[ag].tmp_digest[0] = am[0];
  e[ag].tmp_digest[1] = am[1];
  e[ag].tmp_digest[2] = am[2];
  e[ag].tmp_digest[3] = am[3];
  e[ag].tmp_digest[4] = am[4];
  e[ag].tmp_digest[5] = am[5];
  e[ag].tmp_digest[6] = am[6];
  e[ag].tmp_digest[7] = am[7];
}

__kernel void CG(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global keepass_tmp_t* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global keepass_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
  ...
  ap[0] = s[y].transf_random_seed[0];
  ap[1] = s[y].transf_random_seed[1];
  ap[2] = s[y].transf_random_seed[2];
  ap[3] = s[y].transf_random_seed[3];
  ap[4] = s[y].transf_random_seed[4];
  ap[5] = s[y].transf_random_seed[5];
  ap[6] = s[y].transf_random_seed[6];
  ap[7] = s[y].transf_random_seed[7];

  u32 aq[60];

  CA(ap, aq, aj, ak, al, am, an);

  u32 ar[4];
  u32 as[4];

  ar[0] = e[ag].tmp_digest[0];
  ar[1] = e[ag].tmp_digest[1];
  ar[2] = e[ag].tmp_digest[2];
  ar[3] = e[ag].tmp_digest[3];
  as[0] = e[ag].tmp_digest[4];
  as[1] = e[ag].tmp_digest[5];
  as[2] = e[ag].tmp_digest[6];
  as[3] = e[ag].tmp_digest[7];

  for (u32 ao = 0; ao < aa; ao++) {
    CD(ar, ar, aq, aj, ak, al, am, an);
    CD(as, as, aq, aj, ak, al, am, an);
  }

  e[ag].tmp_digest[0] = ar[0];
  e[ag].tmp_digest[1] = ar[1];
  e[ag].tmp_digest[2] = ar[2];
  e[ag].tmp_digest[3] = ar[3];
  e[ag].tmp_digest[4] = as[0];
  e[ag].tmp_digest[5] = as[1];
  e[ag].tmp_digest[6] = as[2];
  e[ag].tmp_digest[7] = as[3];
}

__kernel void CH(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global keepass_tmp_t* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global keepass_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
  const u32 ah = get_local_id(0);
  const u32 ai = get_local_size(0);
  ...
  au[0] = e[ag].tmp_digest[0];
  au[1] = e[ag].tmp_digest[1];
  au[2] = e[ag].tmp_digest[2];
  au[3] = e[ag].tmp_digest[3];

  u32 av[4];

  av[0] = e[ag].tmp_digest[4];
  av[1] = e[ag].tmp_digest[5];
  av[2] = e[ag].tmp_digest[6];
  av[3] = e[ag].tmp_digest[7];
  ...
  if (s[y].version == 1) {
    ...
    az[0] = s[y].final_random_seed[0];
    az[1] = s[y].final_random_seed[1];
    az[2] = s[y].final_random_seed[2];
    az[3] = s[y].final_random_seed[3];
    ...
    az[2] = s[y].final_random_seed[2];
    az[3] = s[y].final_random_seed[3];
    az[4] = s[y].final_random_seed[4];
    az[5] = s[y].final_random_seed[5];
    az[6] = s[y].final_random_seed[6];
    az[7] = s[y].final_random_seed[7];
  ...
  if (s[y].version == 1) {
    if (s[y].algorithm == 1) {
      ...
      u32 bg = s[y].contents_len;

      u32 bh;
      u32 bi;

      for (bh = 0, bi = 0; bh < bg - 64; bh += 64, bi += 16) {
        for (u32 bj = 0; bj < 16; bj += 4) {
          u32 bk[4];

          bk[0] = M(s[y].contents[bi + bj + 0]);
          bk[1] = M(s[y].contents[bi + bj + 1]);
          bk[2] = M(s[y].contents[bi + bj + 2]);
          bk[3] = M(s[y].contents[bi + bj + 3]);
      ...
      for (bl = 0; bh < bg - 16; bl += 4, bh += 16, bi += 4) {
        u32 bk[4];

        bk[0] = M(s[y].contents[bi + 0]);
        bk[1] = M(s[y].contents[bi + 1]);
        bk[2] = M(s[y].contents[bi + 2]);
        bk[3] = M(s[y].contents[bi + 3]);
      ...
      const u32 bm = bb[3] >> 24;

      const u32 bn = s[y].contents_len - bm;
      ...
      if (s[y].contents_hash[0] == bf[0] && s[y].contents_hash[1] == bf[1] && s[y].contents_hash[2] == bf[2] && s[y].contents_hash[3] == bf[3] && s[y].contents_hash[4] == bf[4] && s[y].contents_hash[5] == bf[5] && s[y].contents_hash[6] == bf[6] && s[y].contents_hash[7] == bf[7]) {
        AA(o, t, y, 0, ad + 0, ag, 0);
      }
    } else {
      u32 bo[60];

      CA(ay, bo, ao, ap, aq, ar, as);

      CB(bo, aj, ak, al, am, an, ao, ap, aq, ar, as);
      ...
      for (bh = 0, bi = 0; bh < bg - 64; bh += 64, bi += 16) {
        for (u32 bj = 0; bj < 16; bj += 4) {
          ...
          bk[0] = s[y].contents[bi + bj + 0];
          bk[1] = s[y].contents[bi + bj + 1];
          bk[2] = s[y].contents[bi + bj + 2];
          bk[3] = s[y].contents[bi + bj + 3];

          u32 bb[4];

          CC(bk, bb, bo, aj, ak, al, am, an);
      ...
      for (bl = 0; bh < bg - 16; bl += 4, bh += 16, bi += 4) {
        ...
        bk[0] = s[y].contents[bi + 0];
        bk[1] = s[y].contents[bi + 1];
        bk[2] = s[y].contents[bi + 2];
        bk[3] = s[y].contents[bi + 3];
    ...
    bp[0] = s[y].contents_hash[0];
    bp[1] = s[y].contents_hash[1];
    bp[2] = s[y].contents_hash[2];
    bp[3] = s[y].contents_hash[3];

    CC(bp, bb, bo, aj, ak, al, am, an);
    ...
    if (s[y].expected_bytes[0] == bb[0] && s[y].expected_bytes[1] == bb[1] && s[y].expected_bytes[2] == bb[2] && s[y].expected_bytes[3] == bb[3]) {
      AA(o, t, y, 0, ad + 0, ag, 0);
    }
  }
}