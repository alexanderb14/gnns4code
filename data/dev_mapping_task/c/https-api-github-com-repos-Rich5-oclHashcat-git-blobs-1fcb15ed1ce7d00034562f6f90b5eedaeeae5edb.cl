...
void CB(u32 a[4], u32 b[4], u32 c[4]) {
  u32 d[2];
  u32 e[2];
  u32 f[2];
  u32 g[2];
...
for (u32 ar = 0; ar < ab; ar += 1) {
  ...
  {
    if (((bj[0]) == aq[0]) && ((bj[1]) == aq[1]) && ((bj[2]) == aq[2]) && ((bj[3]) == aq[3])) {
      const u32 bl = ad + 0;
