...
__kernel void P(__global float* a, int b) {
  union {
    threefry4x32_ctr_t c;
    int4 i;
  } c;
  unsigned d = get_global_id(0);

  threefry4x32_key_t e = {{dcafbad, 0xfacebead, 0x12345678}};
  threefry4x32_ctr_t f = {{badbeef, 0xbeeff00d}};
  c.c = N(threefry4x32_rounds, f, e);
  long g = c.i.x;

  a[d] = 0.5 + ((float)g) / 0xffffffff;
}