...
__kernel void __attribute__((reqd_work_group_size(64, 1, 1))) D(__global pw_t* a, __global pw_t* b, __global kernel_rule_t* c, __global comb_t* d, __global bf_t* e, const u32 f, const u32 g) {
