...
__kernel void BY(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global void* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa, const u32 ab,
  ...
  for (u32 ao = 0; ao < ab; ao += 1) {
    ...
    bf[0] = 0x0101010101010101;
    bf[1] = 0x0101010101010101;
    bf[2] = 0x0101010101010101;
    bf[3] = 0x0101010101010101;
    bf[4] = 0x0101010101010101;
    bf[5] = 0x0101010101010101;
    bf[6] = 0x0101010101010101;
    bf[7] = 0x0101010101010101;
    ...
    const u32x bh = D(bf[0]);
    const u32x bi = E(bf[0]);
    const u32x bj = D(bf[1]);
    const u32x bk = E(bf[1]);

    {
      const u32 bl[4] = {bh, bi, bj, bk};
...
for (u32 ap = 0; ap < ab; ap += 1) {
  ...
  bg[0] = 0x0101010101010101;
  bg[1] = 0x0101010101010101;
  bg[2] = 0x0101010101010101;
  bg[3] = 0x0101010101010101;
  bg[4] = 0x0101010101010101;
  bg[5] = 0x0101010101010101;
  bg[6] = 0x0101010101010101;
  bg[7] = 0x0101010101010101;
  ...
  const u32x bi = D(bg[0]);
  const u32x bj = E(bg[0]);
  const u32x bk = D(bg[1]);
  const u32x bl = E(bg[1]);
