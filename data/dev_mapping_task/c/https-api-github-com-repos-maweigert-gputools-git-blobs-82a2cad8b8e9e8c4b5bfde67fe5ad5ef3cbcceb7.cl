...
__kernel void D(__global float* a, __global float* b, __global float* c, const int d) {
  int e = get_global_id(0);
  int f = get_global_size(0);
...
__kernel void E(__global float* a, __global float* b, __global float* c, const int d, const int e) {
  int f = get_global_id(0);
  int g = get_global_id(1);
...
__kernel void F(__global float* a, __global float* b, __global float* c, const int d, const int e, const int f) {
  int g = get_global_id(0);
  int h = get_global_id(1);
  int i = get_global_id(2);
