...
void A(uint4* restrict a, uint4* restrict b, const uint4 c, const uint4 d, const uint4 e, const uint4 f) {
  ...
  {
    uint4 j, k, l;
    j = (uint4)(i[(0 + 0) % 4].y, i[(0 + 0) % 4].z, i[(0 + 0) % 4].w, i[(0 + 1) % 4].x);
    k = (uint4)(i[(0 + 2) % 4].y, i[(0 + 2) % 4].z, i[(0 + 2) % 4].w, i[(0 + 3) % 4].x);
    l = (uint4)(i[(0 + 3) % 4].z, i[(0 + 3) % 4].w, 0, 0);
    i[(0 + 0) % 4] += k + (rotate(j, 25U) ^ rotate(j, 14U) ^ (j >> 3U)) + (rotate(l, 15U) ^ rotate(l, 13U) ^ (l >> 10U));
    j = (uint4)(0, 0, i[(0 + 0) % 4].x, i[(0 + 0) % 4].y);
    i[(0 + 0) % 4] += (rotate(j, 15U) ^ rotate(j, 13U) ^ (j >> 10U));
  };
  h.w += (rotate(h.x, 26U) ^ rotate(h.x, 21U) ^ rotate(h.x, 7U));
  h.w += bitselect(h.z, h.y, h.x);
  h.w += i[0].x + Gb[15];
  ...
  {
    uint4 j, k, l;
    j = (uint4)(i[(1 + 0) % 4].y, i[(1 + 0) % 4].z, i[(1 + 0) % 4].w, i[(1 + 1) % 4].x);
    k = (uint4)(i[(1 + 2) % 4].y, i[(1 + 2) % 4].z, i[(1 + 2) % 4].w, i[(1 + 3) % 4].x);
    l = (uint4)(i[(1 + 3) % 4].z, i[(1 + 3) % 4].w, 0, 0);
    i[(1 + 0) % 4] += k + (rotate(j, 25U) ^ rotate(j, 14U) ^ (j >> 3U)) + (rotate(l, 15U) ^ rotate(l, 13U) ^ (l >> 10U));
    j = (uint4)(0, 0, i[(1 + 0) % 4].x, i[(1 + 0) % 4].y);
    i[(1 + 0) % 4] += (rotate(j, 15U) ^ rotate(j, 13U) ^ (j >> 10U));
  };
  g.w += (rotate(g.x, 26U) ^ rotate(g.x, 21U) ^ rotate(g.x, 7U));
  g.w += bitselect(g.z, g.y, g.x);
  g.w += i[1].x + Gb[19];
  ...
  {
    uint4 j, k, l;
    j = (uint4)(i[(2 + 0) % 4].y, i[(2 + 0) % 4].z, i[(2 + 0) % 4].w, i[(2 + 1) % 4].x);
    k = (uint4)(i[(2 + 2) % 4].y, i[(2 + 2) % 4].z, i[(2 + 2) % 4].w, i[(2 + 3) % 4].x);
    l = (uint4)(i[(2 + 3) % 4].z, i[(2 + 3) % 4].w, 0, 0);
    i[(2 + 0) % 4] += k + (rotate(j, 25U) ^ rotate(j, 14U) ^ (j >> 3U)) + (rotate(l, 15U) ^ rotate(l, 13U) ^ (l >> 10U));
    j = (uint4)(0, 0, i[(2 + 0) % 4].x, i[(2 + 0) % 4].y);
    i[(2 + 0) % 4] += (rotate(j, 15U) ^ rotate(j, 13U) ^ (j >> 10U));
  };
  h.w += (rotate(h.x, 26U) ^ rotate(h.x, 21U) ^ rotate(h.x, 7U));
  h.w += bitselect(h.z, h.y, h.x);
  h.w += i[2].x + Gb[23];
  ...
  {
    uint4 j, k, l;
    j = (uint4)(i[(3 + 0) % 4].y, i[(3 + 0) % 4].z, i[(3 + 0) % 4].w, i[(3 + 1) % 4].x);
    k = (uint4)(i[(3 + 2) % 4].y, i[(3 + 2) % 4].z, i[(3 + 2) % 4].w, i[(3 + 3) % 4].x);
    l = (uint4)(i[(3 + 3) % 4].z, i[(3 + 3) % 4].w, 0, 0);
    i[(3 + 0) % 4] += k + (rotate(j, 25U) ^ rotate(j, 14U) ^ (j >> 3U)) + (rotate(l, 15U) ^ rotate(l, 13U) ^ (l >> 10U));
    j = (uint4)(0, 0, i[(3 + 0) % 4].x, i[(3 + 0) % 4].y);
    i[(3 + 0) % 4] += (rotate(j, 15U) ^ rotate(j, 13U) ^ (j >> 10U));
  };
  g.w += (rotate(g.x, 26U) ^ rotate(g.x, 21U) ^ rotate(g.x, 7U));
  g.w += bitselect(g.z, g.y, g.x);
  g.w += i[3].x + Gb[27];
