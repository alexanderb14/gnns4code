...
__kernel __attribute__((reqd_work_group_size(1024 / 2, 1, 1))) void C(__global uint* a, __global uint* b, __global uint* c, __global uint* d, uint e, uint f) {
  __local uint g[1024];
  __local uint h[1024];
...
__kernel __attribute__((reqd_work_group_size(1024 / 2, 1, 1))) void D(__global uint* a, __global uint* b, __global uint* c, __global uint* d) {
  __local uint e[1024];
  __local uint f[1024];
...
__kernel __attribute__((reqd_work_group_size(1024 / 2, 1, 1))) void F(__global uint* a, __global uint* b, __global uint* c, __global uint* d, uint e, uint f, uint g, uint h) {
  __local uint i[1024];
  __local uint j[1024];
