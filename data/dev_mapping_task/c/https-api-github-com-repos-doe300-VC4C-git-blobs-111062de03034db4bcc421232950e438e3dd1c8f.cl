...
__kernel void C(__global uint* a, __global uint* b, __global uint* c, __global uint* d, uint e, uint f) {
  __local uint g[512U];
  __local uint h[512U];
...
__kernel void D(__global uint* a, __global uint* b, __global uint* c, __global uint* d) {
  __local uint e[512U];
  __local uint f[512U];
...
__kernel void F(__global uint* a, __global uint* b, __global uint* c, __global uint* d, uint e, uint f, uint g, uint h) {
  __local uint i[512U];
  __local uint j[512U];
