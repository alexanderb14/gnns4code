...
u8 EA(__local RC4_KEY* a, u8 b, u8 c, __global u32* d, u32 e[4]) {
  for (u32 f = 0; f < 4; f++) {
    u32 g = 0;
...
void EC(const u32 a[4], const u32 b[4], const u32 c[4], const u32 d[4], u32 e[4]) {
  u32 f = e[0];
  u32 g = e[1];
  u32 h = e[2];
  u32 i = e[3];
...
void ED(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4]) {
  a[0] = a[0] ^ 0x36363636;
  a[1] = a[1] ^ 0x36363636;
  a[2] = a[2] ^ 0x36363636;
  a[3] = a[3] ^ 0x36363636;
...
void EE(u32 a[4], u32 b[4], u32 c[4], u32 d[4], u32 e[4], u32 f[4], u32 g[4]) {
  g[0] = e[0];
  g[1] = e[1];
  g[2] = e[2];
  g[3] = e[3];
...
int EF(__local RC4_KEY* a, u32 b[4], __global u32* c, const u32 d, const u32 e[4], const u32 f[4]) {
  DZ(a, b);
  ...
  if (((g[2] & 0xff00ffff) != 0x30008163) && ((g[2] & 0x0000ffff) != 0x00008263))
    return 0;

  j = EA(a, i, j, c + 4, h);
  i += 16;

  if (((h[0] & 0x00ffffff) != 0x00000503) && (h[0] != 0x050307A0))
    return 0;
...
void EG(const u32 a[4], const u32 b[4], const u32 c, const u32 d[4], u32 e[4], u32 f[4]) {
  u32 g[4];
  u32 h[4];
  u32 i[4];
  u32 j[4];
...
void EH(__local RC4_KEY* a, u32 b[4], u32 c[4], u32 d[4], u32 e[4], const u32 f, __global pw_t* g, __global kernel_rule_t* h, __global comb_t* i, __global bf_t* j, __global void* k, __global void* l, __global u32* m, __global u32* n, __global u32* o, __global u32* p, __global u32* q, __global u32* r, __global u32* s, __global u32* t, __global plain_t* u, __global digest_t* v, __global u32* w, __global salt_t* x, __global krb5tgs_t* y, __global u32* z, __global u32* aa, const u32 ab,
...
__kernel void EI(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5tgs_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
  ...
  for (u32 an = 0; an < ab; an += 1) {
    ...
    if (EF(&al[ag], av, s[y].edata2, s[y].edata2_len, au, am) == 1) {
      AA(o, t, y, 0, ad + 0, ah, an);
    }
  }
}
...
__kernel void EK(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5tgs_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
}

__kernel void EL(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5tgs_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_local_id(0);
  const u32 ah = get_global_id(0);
...
__kernel void EM(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5tgs_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
}

__kernel void EN(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global void* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global krb5tgs_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
}