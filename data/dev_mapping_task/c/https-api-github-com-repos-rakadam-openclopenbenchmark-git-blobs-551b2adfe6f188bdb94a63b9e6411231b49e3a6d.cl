...
kernel void C(global int* a, global int* b, int c) {
  ...
  for (int g = 0; g < 16; g++) {
    ...
    e[59] = ((e[32])) + (-(e[37]));
    f[0] = ((e[49])) + ((e[55]));
    f[1] = A((-(e[52])) + ((e[53])), d, 1, 1);
    f[2] = A(((e[50])) + ((e[54])), d, 2, 1);
    f[3] = A(((e[51])) + ((e[58])), d, 3, 1);
    f[4] = A((-(e[48])) + ((e[59] << 1)), d, 4, 1);
    f[5] = A(((e[0] << 2)) + (-(e[3] << 2)) + (-(e[12] << 2)) + ((e[15] << 2)) + ((e[24] << 1)) + (-(e[31] << 1)) + ((e[41])) + (-(e[44])), d, 5, 1);
    f[6] = A((-(e[56])) + ((e[57] << 1)), d, 6, 1);
    f[7] = A((-(e[1] << 2)) + ((e[2] << 2)) + ((e[13] << 2)) + (-(e[14] << 2)) + ((e[25] << 1)) + (-(e[30] << 1)) + ((e[40])) + ((e[46])), d, 7, 1);
    f[8] = A((-(e[49])) + ((e[55])), d, 8, 1);
    f[9] = A(((e[52])) + ((e[53])), d, 9, 1);
    f[10] = A((-(e[50])) + ((e[54])), d, 10, 1);
    f[11] = A((-(e[51])) + ((e[58])), d, 11, 1);
    f[12] = A(((e[48] << 1)) + ((e[59])), d, 12, 1);
    f[13] = A((-(e[4] << 2)) + ((e[7] << 2)) + ((e[8] << 2)) + (-(e[11] << 2)) + ((e[27] << 1)) + ((e[28] << 1)) + ((e[43])) + (-(e[47])), d, 13, 1);
    f[14] = A(((e[56] << 1)) + ((e[57])), d, 14, 1);
    f[15] = A(((e[5] << 2)) + (-(e[6] << 2)) + (-(e[9] << 2)) + ((e[10] << 2)) + ((e[26] << 1)) + ((e[29] << 1)) + ((e[42])) + (-(e[45])), d, 15, 1);
    ;
    ;
    f[0] = A(f[0], d, 0, 1);

    for (int h = 0; h < 16; h++) {
      b[get_global_id(0) + (16 + h + g * 16) * 512] = f[h];
    }

    f[0] = B(f[0], d, 0, 1);
    e[0] = ((B(f[1], d, 1, 1) << 2)) + ((B(f[3], d, 3, 1) << 1));
    e[1] = ((f[0] << 2)) + ((B(f[2], d, 2, 1) << 2));
    e[2] = ((B(f[1], d, 1, 1) << 1)) + (-(B(f[3], d, 3, 1) << 2));
    e[3] = ((f[0] << 2)) + (-(B(f[2], d, 2, 1) << 2));
    e[4] = (-(B(f[4], d, 4, 1) << 1)) + (-(B(f[6], d, 6, 1) << 1));
    e[5] = ((B(f[4], d, 4, 1) << 1)) + (-(B(f[6], d, 6, 1) << 1));
    e[6] = ((B(f[5], d, 5, 1) << 1)) + ((B(f[7], d, 7, 1)));
    e[7] = ((B(f[5], d, 5, 1))) + (-(B(f[7], d, 7, 1) << 1));
    e[8] = ((B(f[9], d, 9, 1) << 2)) + ((B(f[11], d, 11, 1) << 1));
    e[9] = (-(B(f[8], d, 8, 1) << 2)) + ((B(f[10], d, 10, 1) << 2));
    e[10] = ((B(f[8], d, 8, 1) << 2)) + ((B(f[10], d, 10, 1) << 2));
    e[11] = ((B(f[9], d, 9, 1) << 1)) + (-(B(f[11], d, 11, 1) << 2));
    e[12] = (-(B(f[12], d, 12, 1) << 1)) + (-(B(f[14], d, 14, 1) << 1));
    e[13] = ((B(f[12], d, 12, 1) << 1)) + (-(B(f[14], d, 14, 1) << 1));
    e[14] = ((B(f[13], d, 13, 1))) + (-(B(f[15], d, 15, 1) << 1));
    e[15] = (-(B(f[13], d, 13, 1) << 1)) + (-(B(f[15], d, 15, 1)));
    e[16] = (-(e[4])) + (-(e[6]));
    e[17] = ((e[4])) + (-(e[6]));
    e[18] = ((e[2])) + ((e[3]));
    e[19] = (-(e[2])) + ((e[3]));
