...
void CL(const u64 a[16], u64 b[8]) {
  u64 c = b[0];
  u64 d = b[1];
  u64 e = b[2];
  u64 f = b[3];
...
void CM(const u64 a[16], const u64 b[8], const u64 c[8], u64 d[8]) {
  d[0] = b[0];
  d[1] = b[1];
  d[2] = b[2];
  d[3] = b[3];
...
void CN(u64 a[16], u64 b[8], u64 c[8]) {
  a[0] ^= 0x3636363636363636;
  a[1] ^= 0x3636363636363636;
  a[2] ^= 0x3636363636363636;
  a[3] ^= 0x3636363636363636;
  a[4] ^= 0x3636363636363636;
  a[5] ^= 0x3636363636363636;
  a[6] ^= 0x3636363636363636;
  a[7] ^= 0x3636363636363636;
  a[8] ^= 0x3636363636363636;
  a[9] ^= 0x3636363636363636;
  a[10] ^= 0x3636363636363636;
  a[11] ^= 0x3636363636363636;
  a[12] ^= 0x3636363636363636;
  a[13] ^= 0x3636363636363636;
  a[14] ^= 0x3636363636363636;
  a[15] ^= 0x3636363636363636;

  b[0] = 0x6a09e667f3bcc908;
  b[1] = 0xbb67ae8584caa73b;
  b[2] = 0x3c6ef372fe94f82b;
  b[3] = 0xa54ff53a5f1d36f1;
  b[4] = 0x510e527fade682d1;
  b[5] = 0x9b05688c2b3e6c1f;
  b[6] = 0x1f83d9abfb41bd6b;
  b[7] = 0x5be0cd19137e2179;

  CL(a, b);

  a[0] ^= 0x6a6a6a6a6a6a6a6a;
  a[1] ^= 0x6a6a6a6a6a6a6a6a;
  a[2] ^= 0x6a6a6a6a6a6a6a6a;
  a[3] ^= 0x6a6a6a6a6a6a6a6a;
  a[4] ^= 0x6a6a6a6a6a6a6a6a;
  a[5] ^= 0x6a6a6a6a6a6a6a6a;
  a[6] ^= 0x6a6a6a6a6a6a6a6a;
  a[7] ^= 0x6a6a6a6a6a6a6a6a;
  a[8] ^= 0x6a6a6a6a6a6a6a6a;
  a[9] ^= 0x6a6a6a6a6a6a6a6a;
  a[10] ^= 0x6a6a6a6a6a6a6a6a;
  a[11] ^= 0x6a6a6a6a6a6a6a6a;
  a[12] ^= 0x6a6a6a6a6a6a6a6a;
  a[13] ^= 0x6a6a6a6a6a6a6a6a;
  a[14] ^= 0x6a6a6a6a6a6a6a6a;
  a[15] ^= 0x6a6a6a6a6a6a6a6a;

  c[0] = 0x6a09e667f3bcc908;
  c[1] = 0xbb67ae8584caa73b;
  c[2] = 0x3c6ef372fe94f82b;
  c[3] = 0xa54ff53a5f1d36f1;
  c[4] = 0x510e527fade682d1;
  c[5] = 0x9b05688c2b3e6c1f;
  c[6] = 0x1f83d9abfb41bd6b;
  c[7] = 0x5be0cd19137e2179;
...
__kernel void CP(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global tc64_tmp_t* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global tc_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
  ...
  ah[0] = CO(ah[0], s[y].keyfile_buf[0]);
  ah[1] = CO(ah[1], s[y].keyfile_buf[1]);
  ah[2] = CO(ah[2], s[y].keyfile_buf[2]);
  ah[3] = CO(ah[3], s[y].keyfile_buf[3]);
  ai[0] = CO(ai[0], s[y].keyfile_buf[4]);
  ai[1] = CO(ai[1], s[y].keyfile_buf[5]);
  ai[2] = CO(ai[2], s[y].keyfile_buf[6]);
  ai[3] = CO(ai[3], s[y].keyfile_buf[7]);
  aj[0] = CO(aj[0], s[y].keyfile_buf[8]);
  aj[1] = CO(aj[1], s[y].keyfile_buf[9]);
  aj[2] = CO(aj[2], s[y].keyfile_buf[10]);
  aj[3] = CO(aj[3], s[y].keyfile_buf[11]);
  ak[0] = CO(ak[0], s[y].keyfile_buf[12]);
  ak[1] = CO(ak[1], s[y].keyfile_buf[13]);
  ak[2] = CO(ak[2], s[y].keyfile_buf[14]);
  ak[3] = CO(ak[3], s[y].keyfile_buf[15]);

  u64 al[16];

  al[0] = ((u64)M(s[y].salt_buf[0])) << 32 | (u64)M(s[y].salt_buf[1]);
  al[1] = ((u64)M(s[y].salt_buf[2])) << 32 | (u64)M(s[y].salt_buf[3]);
  al[2] = ((u64)M(s[y].salt_buf[4])) << 32 | (u64)M(s[y].salt_buf[5]);
  al[3] = ((u64)M(s[y].salt_buf[6])) << 32 | (u64)M(s[y].salt_buf[7]);
  al[4] = ((u64)M(s[y].salt_buf[8])) << 32 | (u64)M(s[y].salt_buf[9]);
  al[5] = ((u64)M(s[y].salt_buf[10])) << 32 | (u64)M(s[y].salt_buf[11]);
  al[6] = ((u64)M(s[y].salt_buf[12])) << 32 | (u64)M(s[y].salt_buf[13]);
  al[7] = ((u64)M(s[y].salt_buf[14])) << 32 | (u64)M(s[y].salt_buf[15]);
  al[8] = 0;
  al[9] = 0;
  al[10] = 0;
  al[11] = 0;
  ...
  an[0] = ((u64)M(ah[0])) << 32 | (u64)M(ah[1]);
  an[1] = ((u64)M(ah[2])) << 32 | (u64)M(ah[3]);
  an[2] = ((u64)M(ai[0])) << 32 | (u64)M(ai[1]);
  an[3] = ((u64)M(ai[2])) << 32 | (u64)M(ai[3]);
  an[4] = ((u64)M(aj[0])) << 32 | (u64)M(aj[1]);
  an[5] = ((u64)M(aj[2])) << 32 | (u64)M(aj[3]);
  an[6] = ((u64)M(ak[0])) << 32 | (u64)M(ak[1]);
  an[7] = ((u64)M(ak[2])) << 32 | (u64)M(ak[3]);
  an[8] = 0;
  an[9] = 0;
  an[10] = 0;
  an[11] = 0;
  ...
  for (u32 aq = 0, ar = 1; aq < (am / 8 / 8); aq += 8, ar += 1) {
    al[8] = (u64)ar << 32 | (u64)0x80000000;
...
__kernel void CQ(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global tc64_tmp_t* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global tc_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
...
__kernel void CR(__global pw_t* a, __global kernel_rule_t* b, __global comb_t* c, __global bf_t* d, __global tc64_tmp_t* e, __global void* f, __global u32* g, __global u32* h, __global u32* i, __global u32* j, __global u32* k, __global u32* l, __global u32* m, __global u32* n, __global plain_t* o, __global digest_t* p, __global u32* q, __global salt_t* r, __global tc_t* s, __global u32* t, __global u32* u, const u32 v, const u32 w, const u32 x, const u32 y, const u32 z, const u32 aa,
                 const u32 ab, const u32 ac, const u32 ad, const u32 ae, const u32 af) {
  const u32 ag = get_global_id(0);
  ...
  an[2] = M(E(e[ag].out[9]));
  an[3] = M(D(e[ag].out[9]));
  an[4] = M(E(e[ag].out[10]));
  an[5] = M(D(e[ag].out[10]));
  an[6] = M(E(e[ag].out[11]));
  an[7] = M(D(e[ag].out[11]));

  u32 ao[8];

  ao[0] = M(E(e[ag].out[12]));
  ao[1] = M(D(e[ag].out[12]));
  ao[2] = M(E(e[ag].out[13]));
  ao[3] = M(D(e[ag].out[13]));
  ao[4] = M(E(e[ag].out[14]));
  ao[5] = M(D(e[ag].out[14]));
  ao[6] = M(E(e[ag].out[15]));
  ao[7] = M(D(e[ag].out[15]));
  ...
  ap[0] = M(E(e[ag].out[16]));
  ap[1] = M(D(e[ag].out[16]));
  ap[2] = M(E(e[ag].out[17]));
  ap[3] = M(D(e[ag].out[17]));
  ap[4] = M(E(e[ag].out[18]));
  ap[5] = M(D(e[ag].out[18]));
  ap[6] = M(E(e[ag].out[19]));
  ap[7] = M(D(e[ag].out[19]));

  u32 aq[8];

  aq[0] = M(E(e[ag].out[20]));
  aq[1] = M(D(e[ag].out[20]));
  aq[2] = M(E(e[ag].out[21]));
  aq[3] = M(D(e[ag].out[21]));
  aq[4] = M(E(e[ag].out[22]));
  aq[5] = M(D(e[ag].out[22]));
  aq[6] = M(E(e[ag].out[23]));
  aq[7] = M(D(e[ag].out[23]));
