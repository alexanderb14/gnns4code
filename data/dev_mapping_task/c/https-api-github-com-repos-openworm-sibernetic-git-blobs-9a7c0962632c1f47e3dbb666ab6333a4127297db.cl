  ...
  do {
    if ((ab = a[u + aa].x) != -1) {
      ...
      if (y < j) {
        ...
        if ((((o[t].w > 2.05f) && (o[t].w < 2.25f)) && ((o[aj].w > 2.25f) && (o[aj].w < 2.35f + 0.f))) || (((o[t].w > 2.25f) && (o[t].w < 2.35f)) && ((o[aj].w > 2.05f) && (o[aj].w < 2.25f)))) {
          ac += 1.0e-5f * (e[ab] * ai - e[s]) * (j - y) / 1000;

          if (((o[t].w > 2.25f) && (o[t].w < 2.35f))) {
            o[t].w = 2.32;
          }
        } else if ((((o[t].w > 2.25f) && (o[t].w < 2.35f)) && ((o[aj].w > 2.25f) && (o[aj].w < 2.35f)))) {
          ac += 1.0e-4f * (e[ab] * ai - e[s]) * (j - y) / 1000;
        } else if ((((o[t].w > 2.0f) && (o[t].w < 2.25f)) && ((o[aj].w > 2.0f) && (o[aj].w < 2.25f)))) {
          ac += 1.0e-4f * (e[ab] * ai - e[s]) * (j - y) / 1000;
        } else if ((((int)o[t].w) == 1) || (((int)o[aj].w) == 1)) {
          ac += 1.0e-4f * (e[ab] * ai - e[s]) * (j - y) / 1000;
...
__kernel void M(__global float2* a, __global float4* b, __global float4* c, __global float4* d, __global uint* e, __global uint2* f, float g, float h, float i, uint j, __global float4* k, uint l, uint m, __global float* n, __global float4* o, float p) {
  ...
  do {
    if ((ae = (int)k[u + r].x) != -1) {
      ...
      x = w - v;
      if (w != 0.f) {
        if (((o[af].w > 2.05f) && (o[af].w < 2.25f)) && ((o[ag].w > 2.05f) && (o[ag].w < 2.25f))) {
          d[t] += -(z / w) * x * p;
        } else {
          d[t] += -(z / w) * x * p * 0.25f;
        }
