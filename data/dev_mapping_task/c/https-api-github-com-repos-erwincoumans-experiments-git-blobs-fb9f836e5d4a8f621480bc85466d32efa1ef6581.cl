...
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void M(__global Body* a, __global Shape* b, __global Constraint4* c, __global int* d, __global int* e, int f, int g, int h) {
  __local int i;
  __local int j;
  __local int k;
