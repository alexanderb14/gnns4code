...
kernel void G(struct StructOneMember a) {
  E(a);
}

kernel void H(struct LargeStructOneMember a) {
  F(a);
}

void I(struct StructTwoMember a) {
  a.y = (int2)(0, 0);
}

void J(struct LargeStructTwoMember a) {
  a.y[0] = (int2)(0, 0);
}
kernel void K(struct StructTwoMember a) {
  I(a);
}

kernel void L(struct LargeStructTwoMember a) {
  J(a);
}